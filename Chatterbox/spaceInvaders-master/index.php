...
<head>
    ...
    <meta name="publisher" content="https://github.com/abbaskhurram255" />
...
<p><span style='font-size: 18px;'>How to play</span><br>A key - move the spaceship (player) to the left<br>
D key - move the spaceship (player) to the right<br>
Space bar or Enter Key - Shoot<br><br>&copy; Chatterbox</p>
        </div>
