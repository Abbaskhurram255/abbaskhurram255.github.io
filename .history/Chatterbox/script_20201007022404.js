...
console.log(msg);
        ...
        let flBWin = window.open('./2D-Breakout-Game-JavaScript-master/', '_blank', "width=460,height=550,resizable=yes,toolbar=no,menubar=no");
        if (flBWin) { window.focus(); } else { alert('Please turn on popups on this site.'); }
      } else if (q26.test(q)) {
        let bOutWin = window.open('./2D-Breakout-Game-JavaScript-master/', '_blank', "width=460,height=550,resizable=yes,toolbar=no,menubar=no");
