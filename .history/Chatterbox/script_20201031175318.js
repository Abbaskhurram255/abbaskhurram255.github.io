...
function ask() {
  ...
  if (q1.test(q)) {
    ...
    if (relaxerAppWin) {
      window.focus();
      msg = "Take a deep breath, hold";
      playText(msg);
      setTimeout(() => {
        msg = "Breath in";
        playText(msg);
      }, 2000);
      const breathOut = setInterval(() => {
        msg = "and out";
        playText(msg);
      }, 2300);
      clearInterval(breathOut);
    ...
    if (expenseTrackerWin) {
      window.focus();
      msg = "Worried about keeping track of your expenses? No problem. I can help you track them, your expenses";
      playText(msg);
