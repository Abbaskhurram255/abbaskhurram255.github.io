...
console.log(msg);
        ...
        let tttWin = window.open('./tic-tac-toe-master/', '_blank', "width=500,height=500,resizable=yes,toolbar=no,menubar=no");
        if (tttWin) { window.focus(); } else { alert('Please turn on popups on this site.'); }
      } else if (q16.test(q)) {
        ...
        let gWin = window.open(games[Math.floor(Math.random() * games.length)], '_blank');
        if (gWin) { window.focus(); log("Launched a random game"); } else { alert('Please turn on popups on this site.'); }
      } else if (q25.test(q)) {
        let bOutWin = window.open('./2D-Breakout-Game-JavaScript-master/', '_blank', "width=460,height=550,resizable=no,toolbar=no,menubar=no");
        if (bOutWin) { window.focus(); } else { alert('Please turn on popups on this site.'); }
      } else if (q26.test(q)) {
        let hManWin = window.open('./FlappyBird-JavaScript-master/', '_blank', "width=380,height=630,resizable=no,toolbar=no,menubar=no");
        if (hManWin) { window.focus(); } else { alert('Please turn on popups on this site.'); }
      } else if (q27.test(q)) {
        let pManWin = window.open('./FlappyBird-JavaScript-master/', '_blank', "width=380,height=630,resizable=no,toolbar=no,menubar=no");
        if (pManWin) { window.focus(); } else { alert('Please turn on popups on this site.'); }
      } else if (q28.test(q)) {
        let flBWin = window.open('./FlappyBird-JavaScript-master/', '_blank', "width=380,height=630,resizable=no,toolbar=no,menubar=no");
        if (flBWin) { window.focus(); } else { alert('Please turn on popups on this site.'); }
      } else {
        $('#message').animate({height:'toggle', opacity: 'toggle'}, 800);
        msg =
