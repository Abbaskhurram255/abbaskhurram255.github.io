...
console.log(msg);
        ...
        if (randStuffWin) { window.focus(); log("Opened a random app"); } else { alert('Please turn on popups on this site.'); }
        	...
        	let games = ['./tic-tac-toe-master/', './2D-Breakout-Game-JavaScript-master/', './FlappyBird-JavaScript-master/', './JavaScript-Pacman-master/', './hangman-master/', './spaceInvaders-master/'];
