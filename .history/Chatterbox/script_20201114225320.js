...
const showFeatures = () => {
  ...
  stopText();
  msg = "Don't underestimate me, hey, because I can perform logical operations too. For example, if you asked me to inform you if 2020 is a leap year, I'd let you know. And if you asked me to inform you of the date it'll be tomorrow or of what date it was yesterday, I'd let you know. Further, if you asked me to ";
  playText(msg);
}
