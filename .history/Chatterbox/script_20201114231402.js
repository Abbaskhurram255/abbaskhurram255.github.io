...
const showFeatures = () => {
  ...
  stopText();
  msg = "Don't underestimate me though, because I can perform logical operations too. For example, if you asked me to inform you whether 2020 or 2021 is a leap year, I'd let you know. And if you asked me to inform you of the date it'll be tomorrow or of the date it was yesterday, I'd let you know. Further, if you asked me to inform you whether this is a weekday or weekend day today, I'd let you know.";
  playText(msg);
}
