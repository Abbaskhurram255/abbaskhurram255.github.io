...
var bday = prompt(
  ...
  const q1 =
   /what'?s?( is)? (up|popping)/gi,
   q2 = /who are you/gi,
   q3 =
   /(who am I)|(my bio)|(what do you know about me)/gi,
   q4 =
   /(how are you)|(how('?ve?| have) you been)/gi,
   q5 = /(what'?s?( is)?|show) my name/gi,
   q6 = /(what'?s?( is)? your name)|(what (can I|do you want me to) call you)/gi,
   q7 = /(is|was)(year )? (this|\d{4})( a)? leap year/i,
   q8 =
   /(what'?s?( is)?|show) my (birthday|b-day|bday|day)/i,
   q9 =
   /(how old am I)|((show|what'?s?( is)?) my age)/gi,
   q10 =
   /(call me by another|change my) name/gi,
   q11 =
   ...
   q27 = /hangman/gi,
   q28 = /pacman(ia)?/gi,
   q29 = /(rock|stone) paper scissors?/gi,
   q30 = /(lyrics)|(encyclopedia)|(lyricopedia)/gi,
   q31 = /currency/gi;
