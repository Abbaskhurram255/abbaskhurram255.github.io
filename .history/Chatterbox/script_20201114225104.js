...
const showFeatures = () => {
  ...
  stopText();
  msg = "Don't underestimate me, hey, because I can perform logical operations too. For example, if you asked me to inform you if 2020 is a leap year, I'd let you know";
  playText(msg);
}
