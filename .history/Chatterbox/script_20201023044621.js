...
function showFeatures() {
  ...
  document.querySelector('.modal-content').innerHTML += `<span class="close">&times;</span><iframe src="./features.html" style="border:none;" height="600" width="90%" onload="resizeIframe(this);"></iframe>`;
}
